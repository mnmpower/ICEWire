...
@Component({
  selector: 'app-beheer-admins',
  templateUrl: './beheer-admins.component.html',
  styleUrls: ['./beheer-admins.component.scss']
})
export class BeheerAdminsComponent implements OnInit {
