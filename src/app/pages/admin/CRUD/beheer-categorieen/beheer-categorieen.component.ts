...
@Component({
  selector: 'app-beheer-categorieen',
  templateUrl: './beheer-categorieen.component.html',
  styleUrls: ['./beheer-categorieen.component.scss']
})
export class BeheerCategorieenComponent implements OnInit {
