...
@Component({
  selector: 'app-beheer-leeftijd',
  templateUrl: './beheer-leeftijd.component.html',
  styleUrls: ['./beheer-leeftijd.component.scss']
})
export class BeheerLeeftijdComponent implements OnInit {
