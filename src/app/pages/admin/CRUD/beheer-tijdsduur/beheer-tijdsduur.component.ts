...
@Component({
  selector: 'app-beheer-tijdsduur',
  templateUrl: './beheer-tijdsduur.component.html',
  styleUrls: ['./beheer-tijdsduur.component.scss']
})
export class BeheerTijdsduurComponent implements OnInit {
  adminID: number;
