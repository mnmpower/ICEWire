...
@Component({
  selector: 'app-beheer-statussen',
  templateUrl: './beheer-statussen.component.html',
  styleUrls: ['./beheer-statussen.component.scss']
})
export class BeheerStatussenComponent implements OnInit {
